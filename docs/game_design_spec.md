...
#### 2.1.2.RaceData Example <!--TODO:完成各属性的示例json-->
...
|        属性         |            类型             |           作用           |                                                   备注                                                   |
| :-----------------: | :-------------------------: | :----------------------: | :------------------------------------------------------------------------------------------------------: |
|       `type`        | [`ItemType`](#1261itemtype) |      标记物品的类型      |                                                    -                                                     |
...
|   `behavior_pool`   |           `list`            | 表示物品可能触发的行为池 |               `list`元素为[`BehaviorComponent`](#512behaviorcomponent)，该属性为非必须属性               |

#### 2.6.2.AttrRange

|     属性     |              类型              |               作用               | 备注  |
| :----------: | :----------------------------: | :------------------------------: | :---: |
|     `id`     | [`Attr::ID`](#12attribute-map) |         表示对应属性的ID         |   -   |
...
### 4.1.Data ID Specifications

|             数据类型             |    ID范围     |
| :------------------------------: | :-----------: |
| [**一级属性**](#12attribute-map) |    $1-100$    |
| [**二级属性**](#12attribute-map) |   $101-300$   |
| [**属性加成**](#12attribute-map) |   $301-500$   |
| [**最终属性**](#12attribute-map) |   $501-700$   |
| [**实时状态**](#12attribute-map) |   $701-800$   |
|   [**种族数据**](#21race-data)   | $10001-11999$ |
|   [**职业数据**](#22job-data)    | $12001-14999$ |
|  [**技能数据**](#23skill-data)   | $20001-39999$ |
|  [**效果数据**](#24effect-data)  | $40001-49999$ |
|   [**Buff数据**](#25buff-data)   | $50001-59999$ |
|   [**武器数据**](#26item-data)   | $60001-64999$ |
|   [**防具数据**](#26item-data)   | $65001-69999$ |
|   [**饰品数据**](#26item-data)   | $70001-74999$ |
|  [**消耗品数据**](#26item-data)  | $75001-79999$ |
|   [**材料数据**](#26item-data)   | $80001-84999$ |
| [**任务物品数据**](#26item-data) | $85001-89999$ |
...
|      属性      |                     类型                      |           作用           | 备注  |
| :------------: | :-------------------------------------------: | :----------------------: | :---: |
| `trigger_type` | [`EffectTriggerType`](#1242effecttriggertype) | 表示该动作的触发时机类型 |   -   |
|    `chance`    |                   `double`                    |         触发几率         |   -   |
| `action_type`  |  [`ActionTargetType`](#1243actiontargettype)  |    表示触发的动作类型    |   -   |
|  `target_id`   |                     `int`                     |     触发的动作目标id     |   -   |

#### 5.1.2.BehaviorComponent

|    属性     |  类型  |               作用               |                         备注                         |
| :---------: | :----: | :------------------------------: | :--------------------------------------------------: |
| `behaviors` | `list` | 表示组件内含有的效果触发动作列表 | `list`元素为[`PassiveAction`](#511passiveaction)类型 |
...
| 属性  |              类型              |         作用         | 备注  |
| :---: | :----------------------------: | :------------------: | :---: |
| `id`  | [`Attr::id`](#12attribute-map) |    对应加成属性id    |   -   |
